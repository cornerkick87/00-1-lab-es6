...
function displayPics() {
  ...
  // DONE TODO: In a sentence or two, explain why the previous line of code threw an error when we changed the variable declaration from `var to `let`.
  //RESPONSE:It throws and error becuase let is a block scope inside the while loop.
  console.log(viewed);
